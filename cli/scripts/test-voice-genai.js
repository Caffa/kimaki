...
var discord_bot_1 = require("../src/discord-bot");
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var token, discordClient;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, discord_bot_1.createDiscordClient)()];
                case 1:
                    ...
                    return [4 /*yield*/, (0, discord_bot_1.startDiscordBot)({ token: token, discordClient: discordClient })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
