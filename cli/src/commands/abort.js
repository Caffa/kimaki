...
exports.handleAbortCommand = handleAbortCommand;
...
var logger = (0, logger_js_1.createLogger)(logger_js_1.LogPrefix.ABORT);
function handleAbortCommand(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var channel, isThread, resolved, projectDirectory, sessionId, runtime, getClient, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    _c.sent();
                    return [2 /*return*/];
                case 4: return [4 /*yield*/, command.deferReply({ flags: discord_utils_js_1.SILENT_MESSAGE_FLAGS })];
                case 5:
                    _c.sent();
                ...
                case 6:
                    resolved = _c.sent();
                    if (!!resolved) return [3 /*break*/, 8];
                    return [4 /*yield*/, command.editReply('Could not determine project directory for this channel')];
                case 7:
                    _c.sent();
                    return [2 /*return*/];
                case 8:
                ...
                case 9:
                    ...
                    return [4 /*yield*/, command.editReply('No active session in this thread')];
                case 10:
                    _c.sent();
                    return [2 /*return*/];
                case 11:
                    runtime = (0, thread_session_runtime_js_1.getRuntime)(channel.id);
                    if (!runtime) return [3 /*break*/, 12];
                ...
                case 13:
                    ...
                    return [4 /*yield*/, command.editReply("Failed to abort: ".concat(getClient.message))];
                case 14:
                    _c.sent();
                    return [2 /*return*/];
                case 15:
                    _c.trys.push([15, 17, , 18]);
                    return [4 /*yield*/, getClient().session.abort({ sessionID: sessionId })];
                case 16:
                    _c.sent();
                    return [3 /*break*/, 18];
                case 17:
                    error_1 = _c.sent();
                    logger.error('[ABORT] API abort failed:', error_1);
                    return [3 /*break*/, 18];
                case 18: return [4 /*yield*/, command.editReply('Request **aborted**')];
                case 19:
                    _c.sent();
                    logger.log("Session ".concat(sessionId, " aborted by user"));
                    return [2 /*return*/];
            }
        });
    });
