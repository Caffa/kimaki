...
exports.handleMemorySnapshotCommand = handleMemorySnapshotCommand;
...
function handleMemorySnapshotCommand(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var filepath, e_1, msg;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _c.trys.push([2, 5, , 7]);
                    return [4 /*yield*/, (0, heap_monitor_js_1.writeHeapSnapshot)()];
                case 3:
                    filepath = _c.sent();
                ...
                case 4:
                    _c.sent();
                    logger.log("Memory snapshot requested via /memory-snapshot: ".concat(filepath));
                    return [3 /*break*/, 7];
                case 5:
                    e_1 = _c.sent();
                    msg = e_1 instanceof Error ? e_1.message : String(e_1);
                    return [4 /*yield*/, command.editReply({
                            content: "Failed to write heap snapshot: ".concat(msg),
                        })];
                case 6:
                    _c.sent();
                    return [3 /*break*/, 7];
