...
var allocateIpAddressQuery = "mutation($input: AllocateIPAddressInput!) {\n  allocateIpAddress(input: $input) {\n    ipAddress {\n      id\n      address\n      type\n      region\n      createdAt\n    }\n  }\n}";
var releaseIpAddressQuery = "mutation($input: ReleaseIPAddressInput!) {\n  releaseIpAddress(input: $input) {\n    app {\n      name\n    }\n  }\n}";
var Network = /** @class */ (function () {
    function Network(client) {
        this.client = client;
    }
    Network.prototype.allocateIpAddress = function (input) {
    ...
    Network.prototype.releaseIpAddress = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.gqlPostOrThrow({
