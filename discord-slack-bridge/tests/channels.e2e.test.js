...
(0, vitest_1.describe)('channels', function () {
    var ctx;
    ...
    (0, vitest_1.test)('guild channels list includes seeded channels', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.test)('fetch single channel returns correct metadata', function () { return __awaiter(void 0, void 0, void 0, function () {
        var channelId, ch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    channelId = ctx.twin.resolveChannelId('general');
                    return [4 /*yield*/, ctx.client.channels.fetch(channelId)];
                case 1:
                    ch = _a.sent();
                    (0, vitest_1.expect)(ch).toBeDefined();
                    (0, vitest_1.expect)(ch.id).toBe(channelId);
                    return [2 /*return*/];
            }
        });
    }); });
